...
import { Settings, User, Bell, Shield, BookOpen, Plus, X, Save, Brain, Clock, Activity, AlertTriangle, Lock, Info, RefreshCw, Moon, TrendingDown, BarChart2, Timer } from 'lucide-react';
  ...
  return (
    <div className="p-6 space-y-6 animate-fade-in max-w-6xl">
      <div>
        ...
        <p className="text-tv-muted text-sm mt-0.5">Manage your profile and behavioral preferences</p>
      </div>
